...
type StockTransactionResource interface {
	...
	Get(ctx context.Context, filters []dto.Filter, order []dto.Order, limit, offset int) (stockTransactions []model.StockTransaction, totalCount int64, errW *error_wrapper.ErrorWrapper)
}
