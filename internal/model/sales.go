...
type Sales struct {
	...
	// ProductID string `gorm:"type:uuid"` // todo: create this in the schema
	// Product   Product `gorm:"foreignKey:ProductID;references:UUID;constraint:onUpdate:CASCADE,onDelete:SET NULL"`
