...
// Source: internal/resource/item/type.go
//
// Generated by this command:
//
//	mockgen -source=internal/resource/item/type.go -destination=mocks/resource/item/function.go
//
...
func (m *MockItemResource) Create(name, supplierID, category string, price float64, unit string) *error_wrapper.ErrorWrapper {
	m.ctrl.T.Helper()
...
func (mr *MockItemResourceMockRecorder) Create(name, supplierID, category, price, unit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockItemResource)(nil).Create), name, supplierID, category, price, unit)
}
...
func (m *MockItemResource) Update(id, supplierID, name, category string, price float64, unit string) *error_wrapper.ErrorWrapper {
	m.ctrl.T.Helper()
...
func (mr *MockItemResourceMockRecorder) Update(id, supplierID, name, category, price, unit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockItemResource)(nil).Update), id, supplierID, name, category, price, unit)
}
